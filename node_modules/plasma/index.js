...
var Plasma = module.exports = function Plasma(options) {
...
Plasma.prototype._initPlasma = function() {
  this.dataLoaders = this.options.dataLoaders || {};
  this.data = this.options.data ||{};
  this.enable('namespace');
  this.dataLoader('read', function (fp) {
    return tryRead(fp);
  });
...
Plasma.prototype.dataLoader = function(ext, fn) {
  if (ext.charAt(0) !== '.') ext = '.' + ext;
  if (typeof fn === 'undefined') {
    return this.dataLoaders[ext];
  }
  this.dataLoaders[ext] = fn;
  return this;
};
